<?php
if( !class_exists( 'FmSupport' ) ) :

	class FmSupport {

		function verifyNonce( ){
            $nonce      = @$_REQUEST['tlp_fm_nonce'];
        ...
        function t($text){
            return __($text, TLP_FOOD_MENU_SLUG);
        }

        function currency_position_list(){
            return array(
                    'left' => __('Left (£99.99)',TLP_FOOD_MENU_SLUG),
                    'right' => __('Right (99.99£)',TLP_FOOD_MENU_SLUG),
                    'left_space' => __('Left with space (£ 99.99)',TLP_FOOD_MENU_SLUG),
                    'right_space' => __('Right with space (99.99 £)',TLP_FOOD_MENU_SLUG)
                );
        }
