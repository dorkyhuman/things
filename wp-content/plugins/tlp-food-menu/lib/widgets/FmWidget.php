...
if (!class_exists('FmWidget')):
    ...
    class FmWidget extends WP_Widget
    {
        ...
        function FmWidget() {
            ...
            $widget_ops = array('classname' => 'widget_tlp_fm', 'description' => __('Display Food menu', TLP_FOOD_MENU_SLUG));
            parent::__construct('widget_tlp_fm', __('TPL Food Menu', TLP_FOOD_MENU_SLUG), $widget_ops);
        }
        ...
        ?>
            ...
            if ($teamQuery->have_posts()) {
                ...
                $html .= "<p>".__('No post found',TLP_FOOD_MENU_SLUG)."</p>";
            }
        ...
        function form($instance) {
            ...
            <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', TLP_FOOD_MENU_SLUG); ?></label>
            ...
            <p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of item to show : ', TLP_FOOD_MENU_SLUG); ?></label>
            ...
            <p><label for="<?php echo @$this->get_field_id('cat'); ?>"><?php _e('Category id (eg. 1,2,7) leave it blank for all:', TLP_FOOD_MENU_SLUG); ?></label>
